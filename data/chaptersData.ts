...
export const chaptersData: ChapterData[] = rawData.map((chapter, index) => ({
  ...chapter,
  id: `${chapter.subject.substring(0, 3).toUpperCase()}-${String(index + 1).padStart(3, '0')}`,
  title: chapter.chapter,
  status: chapter.status as "Not Started" | "Completed" | "In Progress"
}));